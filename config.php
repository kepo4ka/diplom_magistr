...
$user_agents = [
    ...
    'Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1501.78 Safari/537.36 MRCHROME SOC',
...
$current_user_agent = $user_agents[rand(0, count($user_agents) - 1)];
